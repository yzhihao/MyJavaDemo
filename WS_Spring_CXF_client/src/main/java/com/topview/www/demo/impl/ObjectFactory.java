 ...
 * generated in the com.topview.www.demo.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetRole_QNAME = new QName("http://impl.demo.www.topview.com/", "getRole");
    private final static QName _GetRoleByUser_QNAME = new QName("http://impl.demo.www.topview.com/", "getRoleByUser");
    private final static QName _GetRoleByUserResponse_QNAME = new QName("http://impl.demo.www.topview.com/", "getRoleByUserResponse");
    private final static QName _GetRoleResponse_QNAME = new QName("http://impl.demo.www.topview.com/", "getRoleResponse");
    private final static QName _Say_QNAME = new QName("http://impl.demo.www.topview.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://impl.demo.www.topview.com/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.topview.www.demo.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.demo.www.topview.com/", name = "getRole")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.demo.www.topview.com/", name = "getRoleByUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.demo.www.topview.com/", name = "getRoleByUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.demo.www.topview.com/", name = "getRoleResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.demo.www.topview.com/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.demo.www.topview.com/", name = "sayResponse")
